...
| **KMS/HSM issuer key + rotation** | Move the `did:web` issuer Ed25519 key into a KMS/HSM and automate rotation (today it is a managed Secret). | Partial | `README.md` checklist |
